...
const Cakes = () => {
  const cakeImages = Array.from({ length: 26 }, (_, i) => ({
    ...
    description: `A delicious cake perfect for any occasion.`,
    isComingSoon: false, // Set to true if needed
  }));
  ...
  const specialCakes = [
    ...
    },
    {
      ...
      price: '$85.00',
      description: 'A luxurious cake for your special day.',
      isComingSoon: false,
    },
    {
      id: 29,
  ...
  return (
    <div className="products-container">
      ...
      <div className="cakes-grid">
        {allCakes.map((cake) => (
          <BentoTilt key={cake.id} className="product-card">
            <BentoCard
              src={cake.src}
              title={cake.name}
              description={cake.description}
              isComingSoon={cake.isComingSoon}
            />
          </BentoTilt>
        ))}
      </div>
